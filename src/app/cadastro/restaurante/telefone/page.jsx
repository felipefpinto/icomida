...
export default function TelefoneRestaurante() {
  ...
  function continuar() {
    ...
    router.push(
      `/cadastro/restaurante/confirmar-telefone?email=${encodeURIComponent(
        email || ""
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-10">
      <div className="w-full max-w-md">
        <Link
          href={`/cadastro/restaurante/verificar-email?email=${encodeURIComponent(
            email || ""
          )}`}
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-sm leading-relaxed text-gray-500">
              Precisamos do celular do responsável para continuar o cadastro.
            </p>
          </div>
